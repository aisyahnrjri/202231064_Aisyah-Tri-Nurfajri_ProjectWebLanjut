...
```
cd existing_repo
git remote add origin https://github.com/aisyahnrjri/202231064_Aisyah-Tri-Nurfajri_ProjectWebLanjut.git
git branch -M main
...
- [ ] [Set up project integrations](https://github.com/aisyahnrjri/202231064_Aisyah-Tri-Nurfajri_ProjectWebLanjut.git-/settings/integrations)
