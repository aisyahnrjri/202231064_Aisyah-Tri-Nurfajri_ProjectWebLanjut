                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center gap-2">
                                        <form action="{{ route('invoice.index') }}" method="post">
                                            ...
                                            <input type="hidden" name="id_user" value="{{ Auth::guard('admin')->user()->id_user }}">
                                    ...
                                    <td class="d-flex justify-content-center">
                                        <a href="{{ route('invoice.generate', [$penggunaan->id_tagihan]) }}" class="btn btn-sm btn-outline-primary m-0">Cetak Struk</a>
                                    </td>
                                    @endif
                                </tr>
                                @endforeach
