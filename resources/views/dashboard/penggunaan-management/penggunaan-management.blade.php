            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Penggunaan Listrik</h5>
                            <form action="{{route('penggunaan-management.index')}}" class="my-3" method="get">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-gradient-danger text-white">
                                    ...
                                    <td class="d-flex justify-content-center gap-2">
                                        <a href="{{ url('detail-penggunaan-listrik/' . $penggunaan->id_pelanggan) }}" class="btn btn-outline-white btn-sm m-0">
                                            Detail Penggunaan
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-center gap-2">
                                        <a href="{{ url('detail-penggunaan-listrik/' . $penggunaan->id_pelanggan) }}" class="btn btn-outline-primary btn-sm m-0">
                                            Detail Penggunaan
                                        </a>
                                    </td>
                                </tr>
