            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Detail Penggunaan Listrik</h5>
                        ...
                        <div class="d-flex align-items-start">
                            @include('dashboard.penggunaan-management.tambah.tambah-penggunaan-management')
                        </div>
                    </div>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ $penggunaan->meter_awal }}</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ $penggunaan->meter_akhir }}</p>
                                    </td>
                                    <td class="d-flex justify-content-center gap-2">
                                        <a href="javascript:" data-id="{{ $penggunaan->id_penggunaan }}" onclick="editPenggunaan(this)" class="btn btn-outline-primary btn-sm m-0">
                                            Ubah
                                        </a>
                                    </td>
                                </tr>
                        ...
                        @include('dashboard.penggunaan-management.ubah.ubah-penggunaan-management')
                        <div class="px-3 pt-3">
