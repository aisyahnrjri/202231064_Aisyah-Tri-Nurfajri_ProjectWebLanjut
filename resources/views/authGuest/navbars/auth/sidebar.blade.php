<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard.pelanggan') }}">
  ...
  <div class="w-auto">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('dashboard-pelanggan') ? 'active' : '') }}" href="{{ url('dashboard-pelanggan') }}">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('tagihan') ? 'active' : '') }}" href="{{ url('tagihan') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-cash-register ps-2 pe-2 text-center text-dark {{ (Request::is('tagihan') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
      ...
      <li class="nav-item mb-4">
        <a class="nav-link {{ (Request::is('logoutAuth') ? 'active' : '') }}" href="{{ url('logoutAuth') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i style="font-size: 1rem;" class="fas fa-lg fa-right-from-bracket ps-2 pe-2 text-center text-dark {{ (Request::is('logoutAuth') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
          </div>
