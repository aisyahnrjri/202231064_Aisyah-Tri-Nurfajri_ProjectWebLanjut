    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="/profile" method="POST" role="form text-left">
                    @csrf
                    @if($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nama_pelanggan" class="form-control-label">{{ __('Nama Lengkap') }}</label>
                                <div class="@error('nama_pelanggan') border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ Auth::guard('pelanggan')->user()->nama_pelanggan }}" type="text" placeholder="Nama Lengkap" id="nama_pelanggan" name="nama_pelanggan">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('username') border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ Auth::guard('pelanggan')->user()->username }}" type="text" placeholder="Username" id="username" name="username" disabled>
                                    @error('username')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('alamat') border border-danger rounded-3 @enderror">
                                    <textarea name="alamat" id="alamat" class="form-control" placeholder="Alamat" rows="5">{{ Auth::guard('pelanggan')->user()->alamat }}</textarea>
                                    @error('alamat')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
